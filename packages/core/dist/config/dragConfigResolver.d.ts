import { PointerType, DragConfig, InternalDragOptions, Vector2 } from '../types';
...
export declare const dragConfigResolver: {
    ...
    bounds(value?: import('../types').DragBounds | ((state: import('../types').State) => import('../types').DragBounds)): (() => EventTarget | null) | HTMLElement | [Vector2, Vector2];
